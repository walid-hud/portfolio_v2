...
const About = ({ lang = "en" }) => {
  const translations = {
    en: {
      title: "\nABOUT ME \n",
      intro: "Hi, I'm Walid, I'm a web developer and creative coder, I believe in crafting websites that not only work, but websites with personality, charm and a clear sense of vision.",
      webDeveloperHeader: "<----Web Developer---->",
      webDeveloperText: "Most of my work is on the front-end (although I've shipped some back-end features here and there)",
      webDeveloperTools: "I work with React and all the typical tools that go along with it including:",
      webDeveloperConclusion: "That being said, I'm very open to learning and utilizing new tools and technologies as I'm confidant in my fundamentals and problem solving skills.",
      creativeCoderHeader: "<----Creative Coder---->",
      creativeCoderText: "Coding is a creative process, yet, a lot of people, mainly educators and course sellers (and even some developers) have confined this creative process and gave it the sole purpose of \"solving real user problems\", but what if I'm not interested in solving anyone's problem?, what if I just want to express myself or explore a concept using code? To challenge this narrative, I make sure to actively engage in creative coding and abstract and visuals centered projects",
    ...
    fr: {
      title: "\nABOUT ME \n",
      intro: "Salut, je suis Walid, je suis développeur web et codeur créatif, je crois en la création de sites web qui ne fonctionnent pas seulement, mais des sites web avec de la personnalité, du charme et une vision claire.",
      webDeveloperHeader: "<----Développeur Web---->",
      webDeveloperText: "La plupart de mon travail se concentre sur le front-end (bien que j'aie livré quelques fonctionnalités back-end ici et là)",
      webDeveloperTools: "Je travaille avec React et tous les outils typiques qui l'accompagnent, notamment :",
      webDeveloperConclusion: "Cela étant dit, je suis très ouvert à l'apprentissage et à l'utilisation de nouveaux outils et technologies car j'ai confiance en mes fondamentaux et mes compétences en résolution de problèmes.",
      creativeCoderHeader: "<----Codeur Créatif---->",
      creativeCoderText: "Le codage est un processus créatif, pourtant, beaucoup de gens, principalement des éducateurs et des vendeurs de cours (et même certains développeurs) ont confiné ce processus créatif et lui ont donné le seul but de \"résoudre de vrais problèmes d'utilisateurs\", mais que se passe-t-il si je ne suis pas intéressé à résoudre le problème de quelqu'un ?, que se passe-t-il si je veux juste m'exprimer ou explorer un concept en utilisant le code ? Pour défier ce récit, je m'assure de m'engager activement dans le codage créatif et les projets centrés sur l'abstrait et les visuels",
      conceptsCommand: "concepts",
  ...
  return (
    <>
      <pre className="text-xl pt-2 -mb-4 glitch-text">{ascii}</pre>
