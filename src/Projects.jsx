const Projects = ({ lang = "en" }) => {
  const translations = {
    en: {
      project1: {
        ...
        description3:
          "Proofolio AI helps professionals without technical skills create portfolio websites from their resumes using AI.",
      ...
      project2: {
        ...
        description1:
          "A ready-to-use e-commerce template designed for electronics and tech vendors. It supports product management, inventory tracking, and integrates with",
        description2: "for secure payments.",
        description3:
          "The template includes an admin dashboard for managing products and transactions with minimal setup required.",
        techLabel: "Technologies used:",
        tech: "React/Next.js, Stripe, MySQL, Tailwind CSS",
        statusLabel: "Project status:",
        status: "Finished",
      },
    },
    fr: {
      project1: {
        ...
        description3:
          "Proofolio AI aide les professionnels sans compétences techniques à créer des sites web de portfolio à partir de leurs CV en utilisant l'IA.",
      ...
      project2: {
        ...
        description1:
          "Un modèle de commerce électronique prêt à l'emploi conçu pour les vendeurs d'électronique et de technologie. Il prend en charge la gestion des produits, le suivi des stocks et s'intègre avec",
        description2: "pour des paiements sécurisés.",
        description3:
          "Le modèle inclut un tableau de bord administrateur pour gérer les produits et les transactions avec une configuration minimale requise.",
        techLabel: "Technologies utilisées:",
        tech: "React/Next.js, Stripe, MySQL, Tailwind CSS",
        statusLabel: "État du projet:",
        status: "Terminé",
  ...
  return (
    <div className="flex flex-col my-4">
      ...
      >
        <div className="md:w-1/2 space-y-2">
          ...
          <p>
            ...
            <a
              href="https://www.linkedin.com/in/yahya-elouarrak/"
              className="text-primary underline px-2 hover:no-underline"
            >
              Yahaya Elouarrak
            </a>
      ...
      <div
        id="project_card_2"
        className="flex flex-col md:flex-row    rounded-md   mt-4"
      >
        <div className="md:w-1/2 space-y-2">
          <h2 className="text-xl font-semibold">{t.project2.title}</h2>
          <p>
